...
function runSwapElement(swpswapedElementarr) {
    swpswapedElementarr.map(function (element, curidx, self) {
        setTimeout(function () {
            ...
            var spanComparsion = document.getElementById('comparison');
            var spanPercentage = document.getElementById('percentage');
            ...
            new Promise(function (resolve, reject) { return resolve(false); })
                .then(function (arg) { return isRun = arg; });
        }, 10);
    });
}
